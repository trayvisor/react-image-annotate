...
export var Annotator = function Annotator(_ref) {
  var images = _ref.images,
      ...
      _ref$regionPrdList = _ref.regionPrdList,
      regionPrdList = _ref$regionPrdList === void 0 ? [] : _ref$regionPrdList,
      ...
      _ref$imagePrdList = _ref.imagePrdList,
      imagePrdList = _ref$imagePrdList === void 0 ? [] : _ref$imagePrdList,
  ...
  var onRegionProductAdded = useEventCallback(function (prd) {
    dispatchToReducer({
      type: "ON_PRD_ADDED",
      prd: prd
    });
