...
export var RegionLabel = function RegionLabel(_ref) {
  var region = _ref.region,
      ...
      allowedProducts = _ref.allowedProducts,
      onDelete = _ref.onDelete,
      _onChange = _ref.onChange,
      onClose = _ref.onClose,
      onOpen = _ref.onOpen,
      onRegionClassAdded = _ref.onRegionClassAdded,
      onRegionProductAdded = _ref.onRegionProductAdded,
  ...
  return /*#__PURE__*/React.createElement(ThemeProvider, {
  ...
  }), region.cls), region.prd && /*#__PURE__*/React.createElement("div", {
    className: "name"
  }, /*#__PURE__*/React.createElement("div", {
    className: "circle",
    style: {
  ...
  }), region.prd), region.tags && /*#__PURE__*/React.createElement("div", {
    className: "tags"
  ...
  })), (allowedProducts || []).length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6
    }
  }, /*#__PURE__*/React.createElement(CreatableSelect, {
    ...
    options: asMutable(allowedProducts.map(function (c) {
      return {
        value: c,
        label: c
      };
